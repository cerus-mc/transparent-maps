package dev.cerus.transparentmaps.nms.v1_18_R2;
...
public class NmsAdapterImpl implements NmsAdapter {
    ...
    public void saveWorldMap(final ItemStack itemStack, final World world) {
        ...
        if (worldMap == null) {
            final int id = ItemWorldMap.a(worldServer, worldServer.M.a(), worldServer.M.c(), 3, false, false, worldServer.aa());
            nmsStack.u().a("map", NBTTagInt.a(id));
            worldMap = ItemWorldMap.a(nmsStack, worldServer);
        }
        worldServer.a("map_" + nmsStack.u().h("map"), worldMap);
        worldMap.h = true;
