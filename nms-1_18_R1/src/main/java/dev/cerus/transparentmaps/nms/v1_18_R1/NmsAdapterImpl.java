package dev.cerus.transparentmaps.nms.v1_18_R1;
...
public class NmsAdapterImpl implements NmsAdapter {
    ...
    public void saveWorldMap(final ItemStack itemStack, final World world) {
        ...
        if (worldMap == null) {
            final int id = ItemWorldMap.a(worldServer, worldServer.N.a(), worldServer.N.c(), 3, false, false, worldServer.aa());
            nmsStack.t().a("map", NBTTagInt.a(id));
            worldMap = ItemWorldMap.a(nmsStack, worldServer);
        }
        worldServer.a("map_" + nmsStack.t().h("map"), worldMap);
        worldMap.h = true;
