package dev.cerus.transparentmaps.nms.v1_20_R3;
...
public class NmsAdapterImpl implements NmsAdapter {
    ...
    public void saveWorldMap(final ItemStack itemStack, final World world) {
        ...
        if (worldMap == null) {
            final int id = ItemWorldMap.a(worldServer, worldServer.A.a(), worldServer.A.c(), 3, false, false, worldServer.getMinecraftWorld().ae());
    ...
    public boolean acceptsVersion(final int major, final int minor, final Integer patch) {
        return major == 1 && minor == 20 && patch != null && patch == 4;
    }
