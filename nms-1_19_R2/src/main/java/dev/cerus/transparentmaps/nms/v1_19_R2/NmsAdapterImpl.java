package dev.cerus.transparentmaps.nms.v1_19_R2;
...
public class NmsAdapterImpl implements NmsAdapter {
    ...
    public void saveWorldMap(final ItemStack itemStack, final World world) {
        ...
        if (worldMap == null) {
            final int id = ItemWorldMap.a(worldServer, worldServer.N.a(), worldServer.N.c(), 3, false, false, worldServer.getMinecraftWorld().ac());
