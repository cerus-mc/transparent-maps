package dev.cerus.transparentmaps.nms.v1_19_R3;
...
public class NmsAdapterImpl implements NmsAdapter {
    ...
    public void saveWorldMap(final ItemStack itemStack, final World world) {
        ...
        if (worldMap == null) {
            final int id = ItemWorldMap.a(worldServer, worldServer.A.a(), worldServer.A.c(), 3, false, false, worldServer.getMinecraftWorld().ab());
